...
| <font color="Red">第 6 回</font> | [グラフ理論](https://qiita.com/MandoNarin/items/9976ecff2ecd0521f8b6)         |
...
ループ 2 では、未訪問の最短距離が最小となる頂点は 3 が選ばれます。3 に隣接している未訪問の頂点 4 への距離は、現在の`dist[4]`より小さいので更新されます。
